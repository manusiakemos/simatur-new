    ...
    <div class="row">
        ...
        <div class="col-12">
            <b-modal :title="modal_title"
                ...
                <b-form-group
                    label="Tipe Pemilik"
                    label-for="tower_owner_type"
                    :invalid-feedback="this.errors && this.errors.tower_owner_type ? this.errors.tower_owner_type.join() : ''"
                    :state="this.errors && this.errors.tower_owner_type ? false : true"
                >
                    <select-ajax id="tower_owner_type"
                                 api-url="/api/select/tower_owner_type"
                                 option-text="text"
                                 option-value="value"
                                 v-model="data.tower_owner_type"
                    ></select-ajax>
                </b-form-group>
                <b-form-group
                    label="Tahun"
            ...
            return {
                ...
                configDt: {
                    ...
                    columns: [
                        ...
                        {
                            name: "tower_owner_type",
                            print: true,
                            title: "Tipe Pemilik",
                            data: "tower_owner_type",
                            class: "auto"
                        },
