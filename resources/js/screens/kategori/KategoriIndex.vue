        ...
        <div class="col-12">
            ...
            <b-card class="shadow-sm" border-variant="light">
                ...
                <div v-if="data_print" id="print" class="d-none d-print-block">
                    <h4 class="text-center text-capitalize">Laporan kategori</h4>
        ...
        <div class="col-12">
            <b-modal :title="modal_title"
                ...
                <b-form-group
                    ...
                    :invalid-feedback="this.errors && this.errors.kategori_nama ? this.errors.kategori_nama.join() : ''"
                    :state="this.errors && this.errors.kategori_nama ? false : true"
                >
                    <b-form-input id="kategori_nama"
                                  v-model="data.kategori_nama"
                    ></b-form-input>
                </b-form-group>
                <b-form-group
                    label="Slug"
                    label-for="kategori_slug"
                    :invalid-feedback="this.errors && this.errors.kategori_slug ? this.errors.kategori_slug.join() : ''"
                    :state="this.errors && this.errors.kategori_slug ? false : true"
                >
                    <b-form-input id="kategori_slug"
                                  v-model="data.kategori_slug"
                    ></b-form-input>
                </b-form-group>
                <b-form-group
                    label="Publish"
                    label-for="kategori_status"
                    :invalid-feedback="this.errors && this.errors.kategori_status ? this.errors.kategori_status.join() : ''"
                    :state="this.errors && this.errors.kategori_status ? false : true"
                >
                    <radio-ajax v-model="data.kategori_status"
                ...
                <b-form-group
                    label="Gambar"
                    label-for="kategori_gambar"
                    :invalid-feedback="this.errors && this.errors.kategori_gambar ? this.errors.kategori_gambar.join() : ''"
                    :state="this.errors && this.errors.kategori_gambar ? false : true"
                >
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                configDt: {
                    ...
                    columns: [
                        {name: "kategori_nama", print: true, title: "Nama", data: "kategori_nama", class: "auto"},
                        {name: "kategori_slug", print: true, title: "Slug", data: "kategori_slug", class: "auto"},
                        {
                        ...
                        {name: "kategori_gambar", print: true, title: "Gambar", data: "kategori_gambar", class: "auto"},
        ...
        methods: {
            async generatePdf() {
                var res = await this.axios.get('/api/kategori?print=true');
            ...
            setDt() {
                ...
                $(el).find("#dt-kategori").on("click", ".btn-edit", function (e) {
                    e.preventDefault();
            ...
            destroy(url) {
                this.$dialog.confirm('Apakah Kamu Yakin?').then(() => {
                    ...
                    this.$message({
                        type: 'info',
                        message: 'Kategori batal dihapus'
                    });
                    this.refreshDt();
                });
            }
